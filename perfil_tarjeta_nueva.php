...
if (!empty($_POST['nombre'])  &&!empty($_POST['banco'])  && !empty($_POST['numerotarjeta']) &&!empty($_POST['mesvencimiento'])  &&!empty($_POST['yearvencimiento'])  && !empty($_POST['ccv'])) {
    ...
    $mysql = "INSERT INTO pago (idcliente,nombre,banco,numerotarjeta,mesvencimiento,yearvencimiento,ccv) VALUES (:id,:nombre,:banco,:numerotarjeta,:mesvencimiento,:yearvencimiento,:ccv)";
        ...
        <div class="shadow p-3 mb-5 bg-body rounded">
            ...
            <?php else : ?>
                <div class="contenedor">
                    ...
                    <!-- Formulario -->
                    <form action="perfil_tarjeta_nueva.php" method="POST" id="formulario-tarjeta" class="formulario-tarjeta">
                        <div class="grupo">
